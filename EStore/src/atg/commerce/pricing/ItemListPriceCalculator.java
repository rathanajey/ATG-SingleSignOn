 ...
 * @version $Id: //product/DCS/version/10.0.2/Java/atg/commerce/pricing/ItemListPriceCalculator.java#2 $$Change: 633752 $
  ...
  extends ItemPriceCalculator
{
  ...
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.2/Java/atg/commerce/pricing/ItemListPriceCalculator.java#2 $$Change: 633752 $";
    ...
    throws PricingException
  {
	...
	logDebug("rounded item list price to: " + listPrice);
      ...
      System.out.println("pPriceQuote.getListPrice............"+ pPriceQuote.getListPrice());
      System.out.println("pPriceQuote.getAmount............"+ pPriceQuote.getAmount());
